      ...
      <div className="flex items-center gap-4">
        <div className="flex flex-col items-end">
          <div className="text-[10px] text-neutral-500 dark:text-zinc-400 font-medium">
            <span className="font-bold text-emerald-600 dark:text-emerald-500">GPEOrq</span> /{' '}
            <span className="font-bold text-emerald-600 dark:text-emerald-500">GPSEM</span> —
            Unoeste •{' '}
            <a
              href="https://www.instagram.com/gpeorq"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-emerald-500 transition-colors underline decoration-emerald-500/30 underline-offset-2"
            >
              @gpeorq
            </a>
            {' · '}
